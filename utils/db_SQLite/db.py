...
class Database:
    ...
    def add_task(self, symbol, target_price):
        with self.connection:
            return self.cursor.execute('INSERT INTO "tasks" ("symbol", "target_price") VALUES (?, ?)', (symbol, target_price,))
    ...
    def delete_task_2(self, symbol, target_price):
        with self.connection:
            return self.cursor.execute('DELETE FROM "tasks" WHERE symbol = ? AND target_price = ?', (symbol, target_price,))
